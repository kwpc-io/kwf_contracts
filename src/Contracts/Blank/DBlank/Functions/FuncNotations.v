...
Require Import Contracts.Blank.DBlank.Functions.FuncSig.
...
Definition kwdpool_code_hash__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_kwdpool_code_hash__ ) : ULValue ( XUInteger256 ) ) . 
Definition kwdpool_code_hash__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_kwdpool_code_hash__ ) : URValue ( XUInteger256 ) false ) . 
...
Definition kwdpool_code_depth__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_kwdpool_code_depth__ ) : ULValue ( XUInteger16 ) ) . 
Definition kwdpool_code_depth__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_kwdpool_code_depth__ ) : URValue ( XUInteger16 ) false ) . 
...
Definition fromgiver_code_hash__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_fromgiver_code_hash__ ) : ULValue ( XUInteger256 ) ) . 
Definition fromgiver_code_hash__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_fromgiver_code_hash__ ) : URValue ( XUInteger256 ) false ) . 
...
Definition fromgiver_code_depth__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_fromgiver_code_depth__ ) : ULValue ( XUInteger16 ) ) . 
Definition fromgiver_code_depth__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_fromgiver_code_depth__ ) : URValue ( XUInteger16 ) false ) . 
...
Definition givers_summa__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_givers_summa__ ) : ULValue ( XUInteger128 ) ) . 
Definition givers_summa__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_givers_summa__ ) : URValue ( XUInteger128 ) false ) . 
...
Definition investors_adj_summa__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_investors_adj_summa__ ) : ULValue ( XUInteger128 ) ) . 
Definition investors_adj_summa__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_investors_adj_summa__ ) : URValue ( XUInteger128 ) false ) . 
...
Definition investors_summa__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_investors_summa__ ) : ULValue ( XUInteger128 ) ) . 
Definition investors_summa__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_investors_summa__ ) : URValue ( XUInteger128 ) false ) . 
...
Definition min_summa__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_min_summa__ ) : ULValue ( XUInteger128 ) ) . 
Definition min_summa__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_min_summa__ ) : URValue ( XUInteger128 ) false ) . 
...
Definition max_summa__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_max_summa__ ) : ULValue ( XUInteger128 ) ) . 
Definition max_summa__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_max_summa__ ) : URValue ( XUInteger128 ) false ) . 
...
Definition lock_time__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_lock_time__ ) : ULValue ( XUInteger32 ) ) . 
Definition lock_time__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_lock_time__ ) : URValue ( XUInteger32 ) false ) . 
...
Definition unlock_time__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_unlock_time__ ) : ULValue ( XUInteger32 ) ) . 
Definition unlock_time__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_unlock_time__ ) : URValue ( XUInteger32 ) false ) . 
...
Definition farm_rate__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_farm_rate__ ) : ULValue ( XUInteger8 ) ) . 
Definition farm_rate__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_farm_rate__ ) : URValue ( XUInteger8 ) false ) . 
...
Definition kwf_lock_time__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_kwf_lock_time__ ) : ULValue ( XUInteger32 ) ) . 
Definition kwf_lock_time__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_kwf_lock_time__ ) : URValue ( XUInteger32 ) false ) . 
...
Definition quant__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_quant__ ) : ULValue ( XUInteger128 ) ) . 
Definition quant__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_quant__ ) : URValue ( XUInteger128 ) false ) . 
...
Definition nonce__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_nonce__ ) : ULValue ( XUInteger256 ) ) . 
Definition nonce__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_nonce__ ) : URValue ( XUInteger256 ) false ) . 
...
Definition num_investors_sent__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_num_investors_sent__ ) : ULValue ( XUInteger32 ) ) . 
Definition num_investors_sent__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_num_investors_sent__ ) : URValue ( XUInteger32 ) false ) . 
...
Definition num_investors_received__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_num_investors_received__ ) : ULValue ( XUInteger32 ) ) . 
Definition num_investors_received__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_num_investors_received__ ) : URValue ( XUInteger32 ) false ) . 
...
Definition can_change_kwdpool_code__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_can_change_kwdpool_code__ ) : ULValue ( XBool  ) ) . 
Definition can_change_kwdpool_code__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_can_change_kwdpool_code__ ) : URValue ( XBool  ) false ) . 
...
Definition can_change_fromgiver_code__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_can_change_fromgiver_code__ ) : ULValue ( XBool  ) ) . 
Definition can_change_fromgiver_code__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_can_change_fromgiver_code__ ) : URValue ( XBool  ) false ) . 
...
Definition num_from_givers__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_num_from_givers__ ) : ULValue ( XUInteger32 ) ) . 
Definition num_from_givers__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_num_from_givers__ ) : URValue ( XUInteger32 ) false ) . 
...
Definition voted_for__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_voted_for__ ) : ULValue ( XUInteger128 ) ) . 
Definition voted_for__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_voted_for__ ) : URValue ( XUInteger128 ) false ) . 
...
Definition voted_against__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_voted_against__ ) : ULValue ( XUInteger128 ) ) . 
Definition voted_against__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_voted_against__ ) : URValue ( XUInteger128 ) false ) . 
...
Definition voting_start_time__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_voting_start_time__ ) : ULValue ( XUInteger32 ) ) . 
Definition voting_start_time__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_voting_start_time__ ) : URValue ( XUInteger32 ) false ) . 
...
Definition voting_time__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_voting_time__ ) : ULValue ( XUInteger32 ) ) . 
Definition voting_time__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_voting_time__ ) : URValue ( XUInteger32 ) false ) . 
...
Definition voting_result__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_voting_result__ ) : ULValue ( XMaybe  (  XBool  ) ) ) . 
Definition voting_result__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_voting_result__ ) : URValue ( XMaybe  (  XBool  ) ) false ) . 
...
Definition voting_code_hash__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_voting_code_hash__ ) : ULValue ( XUInteger256 ) ) . 
Definition voting_code_hash__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_voting_code_hash__ ) : URValue ( XUInteger256 ) false ) . 
...
Definition voting_id__left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_voting_id__ ) : ULValue ( XUInteger8 ) ) . 
Definition voting_id__right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_voting_id__ ) : URValue ( XUInteger8 ) false ) . 
...
Definition code_updated_left := ( ULState Ledger_MainState (ContractLEmbeddedType DBlank_ι_code_updated_ ) : ULValue ( XBool  ) ) . 
Definition code_updated_right := ( URState Ledger_MainState (H:=ContractLEmbeddedType DBlank_ι_code_updated_ ) : URValue ( XBool  ) false ) . 
